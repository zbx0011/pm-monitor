"""
生成所有钯金合约配对的价差数据
广期所: PD2606, PD2608, PD2610, PD2612
...
# 合约配置
GFEX_CONTRACTS = {
    'PD2606': {'name': '2606', 'month': '2026年6月'},
    'PD2608': {'name': '2608', 'month': '2026年8月'},
    'PD2610': {'name': '2610', 'month': '2026年10月'},
    'PD2612': {'name': '2612', 'month': '2026年12月'}
}
...
def main():
    ...
    for gfex_sym, gfex_info in GFEX_CONTRACTS.items():
        ...
        for cme_sym, cme_info in CME_CONTRACTS.items():
            ...
            if len(history) > 0:
                ...
                db_history = get_pair_history('palladium', pair_name)
                if db_history:
    ...
    with open('palladium_all_pairs.json', 'w', encoding='utf-8') as f:
